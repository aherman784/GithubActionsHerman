[![Run App AlexHerman](https://github.com/aherman784/GithubActionsHerman/actions/workflows/run-app.yaml/badge.svg)](https://github.com/aherman784/GithubActionsHerman/actions/workflows/run-app.yaml)
